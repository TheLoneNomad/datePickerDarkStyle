...
;(function (global, factory) {
    ...
    let defaultLocaleMonths = 'Января_Февраля_Марта_Апреля_Мая_Июня_Июля_Августа_Сентября_Октября_Ноября_Декабря'.split(
            '_'
        ),
        defaultLocaleMonthsShort = 'Янв._Февр._Мар._Апр._Мая_Июня_Июля_Авг._Сент._Окт._Нояб._Дек.'.split(
            '_'
        ),
