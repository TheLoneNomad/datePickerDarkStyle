...
(function (root, factory) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            ...
            '<div class="daterangepicker">' +
                ...
                '<div class="drp-calendar right">' +
                    ...
                    '<div class="calendar-time"></div>' +
                '</div>' +
                '<div class="drp-buttons gradient-buttons">' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            let calendar_ = side === 'left' ? this.leftCalendar : this.rightCalendar;
            let month = calendar_.month.month();
            let year = calendar_.month.year();
            let hour = calendar_.month.hour();
            let minute = calendar_.month.minute();
            let second = calendar_.month.second();
